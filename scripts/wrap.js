    ...
    var temp = `(function ($, skuid, window)
            {
              ...
              skuid.builder.registerBuilder(new skuid.builder.Builder(Object.assign(${Fs.readFileSync(Path.resolve(Constants.COMPONENT_DIRECTORY, component, 'builder.json'))}, ${component}Options, { id: "${Constants.PACKAGE_ID}__${compId}" })));
  ...
  Functions.forComponent(component => {
    var compId = `${component}`,
      ...
      temp = `(function ($, skuid, window)
        {
            skuid.componentType.register("${Constants.PACKAGE_ID}__${compId}", function (element, xmlDefinition, component)
            {
